...
{
    public static WebApplication MigrateDbContext<TContext>(this WebApplication webHost, Action<TContext,
        IServiceProvider> seeder) where TContext : DbContext
    {
        using (var scope = webHost.Services.CreateScope())
        {
            ...
            try
            {
                ...
                //if the postgres container is not created on run docker compose this
